...
class BatchProver:
    ...
    def prove_batch(self, transactions: List[VoteTransaction]) -> Tuple[str, str, List[int]]:
        """
    ...
    def get_program_input(self, transactions: List[VoteTransaction]):
        """
        ...
        for tx in transactions:
            program_input["transactions"].append(
                ...
                "token_b_amount": tx.token_b_amount}
            )
    ...
    def submit_job(self, program_input) -> Tuple[str, str, List[int]]:
        ...
        # Create a temporary JSON file with the contents of the program_input variable
        # this temporary json file will be loaded in to the cairo compiler as a source of program_input 
        # https://www.cairo-lang.org/docs/reference/syntax.html?highlight=program_input#program-input
